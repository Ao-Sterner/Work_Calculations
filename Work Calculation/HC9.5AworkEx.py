...
print("\nWork Calculations from Hydrocarbon graphs, 9.5 Angstroms: Extrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([50.184917, 100.6008, 113.23399, 125.87796, 151.19697, 201.952, 252.85251, 406.34206, 509.26782, 1347.0362])
nmol = np.array([1.14, 1.4, 1.69, 2.24, 40, 48.1, 49.6, 52.4, 53, 61.9])
