...
print("\nWork Calculations from Hydrocarbon graphs, 5 Angstroms: Extrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([2260.6302, 2533.379, 2752.8211, 3028.6343, 3306.0836])
nmol = np.array([1.5, 7.2, 18.3, 25.1, 27.9])
