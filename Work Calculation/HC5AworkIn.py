...
print("\nWork Calculations from Hydrocarbon graphs, 5 Angstroms: Intrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([1030.1112, 1241.0522, 1453.3514, 1666.9472, 
1881.7884, 2097.8317, 2402.2412, 2566.2257, 2642.9639, 2918.1102, 
3194.9102, 3529.1934, 3865.7313, 4317.856])
nmol = np.array([0.37, 0.38, 0.48, 0.55, 0.94, 1.4, 4.5, 9.7, 13, 23.7, 
                 27.1, 29.1, 31.1, 33.7])
