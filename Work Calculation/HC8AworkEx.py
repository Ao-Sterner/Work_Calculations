...
print("\nWork Calculations from Hydrocarbon graphs, 8 Angstroms: Extrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([1.0002392, 50.184917, 100.6008, 252.85251, 303.88897, 406.34206, 432.03056, 509.26782, 591.92768, 758.04772, 1241.0522])
nmol = np.array([0.8, 0.8, 1, 2.4, 5.4, 10.4, 13.6, 23.1, 27.3, 31.3, 36.6])
