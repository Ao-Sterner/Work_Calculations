...
print("\nWork Calculations from Graphene graphs, 6 Angstroms: Extrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([1135.4076, 1347.0362, 1559.9907, 1827.9638, 2097.8317, 2206.2922, 2642.9639, 2918.1102])
nmol = np.array([1.2, 3.3, 9.7, 21, 25, 26.5, 29, 29.7])
