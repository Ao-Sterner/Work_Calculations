...
print("\nWork Calculations from Hydrocarbon graphs, 7 Angstroms: Extrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([1.0002392, 100.6008, 201.952, 303.88897, 406.34206, 509.26782, 612.6353, 716.42083, 925.17334, 1135.4076])
nmol = np.array([0.6, 1.1, 1.7, 2.9, 5.5, 11.2, 18.45, 23.7, 28.3, 30.95])
