...
print("\nWork Calculations from Graphene graphs, 6 Angstroms: Intrusion\n")

#pressure in bar = i in increments of 1 bar
pbulk = np.array([1030.1112, 1241.0522, 1453.3514, 1666.9472, 1881.7884, 2097.8317, 2315.0395, 2424.0697, 2752.8211, 3083.9946, 3417.5121, 3753.3052])
nmol = np.array([1, 2, 6.3, 14.3, 23.1, 26.3, 28.3, 28.3, 29.5, 30, 30.7, 31.5])
